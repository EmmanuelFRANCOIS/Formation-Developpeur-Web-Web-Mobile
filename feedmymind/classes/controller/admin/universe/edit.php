...
if ( $right && isset($_POST['save']) ) {   // Save mode
  ...
  $universe = $modelUniverse->getUniverse( $_POST['id'] );
  ...
  if ( $_FILES['image']["name"] != "" && $_FILES['image']["name"] != null ) {
    ...
    $_POST['image'] = $upload['uploadOk'] ? $upload['file_name'] : $universe['image'];
  } else if ( $universe['image'] !== "" && $universe['image'] !== null ) {
    $_POST['image'] = $universe['image'];
  } else {
    $_POST['image'] = null;
  }
