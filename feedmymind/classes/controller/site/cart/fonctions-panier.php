    ...
    <div class="container">
      ...
      <?php } else { ?>
          <form method="POST" action="panier.php">
            ...
            <table id="tableCart" class="w-100 table-bordered border-secondary table-light table-striped table-hover">
              ...
              <tbody class="table-group-divider">
                <?php for ( $i=0; $i < $nbArticles; $i++ ) { ?>
                  <tr>
                    <td class="text-center p-3"><?php echo htmlspecialchars($_SESSION['panier']['idProduit'][$i]); ?></td>
                    <td class="fw-bold text-success p-3"><?php echo htmlspecialchars($_SESSION['panier']['libelleProduit'][$i]); ?></td>
                    <td class="p-3"><?php echo htmlspecialchars($_SESSION['panier']['auteurProduit'][$i]); ?></td>
                    <td class="text-center p-3"><input type="number" size="4" name="q[]" value="<?php echo htmlspecialchars($_SESSION['panier']['qteProduit'][$i]); ?>"></td>
                    <td class="text-end p-3"><?php echo htmlspecialchars($_SESSION['panier']['prixProduit'][$i]); ?> €</td>
              ...
              <tfoot class="table-group-divider bg-light">
                <tr>
                  ...
                  <td class="fw-bold text-dark text-uppercase text-end p-3">Total : <?php echo MontantGlobal(); ?> €</td>
                  <td class="text-end p-3">
                    <?php if ( $nbArticles > 0 ) { ?>
