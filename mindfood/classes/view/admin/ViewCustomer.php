...
?>
            <tr>
              ...
              <td><?php echo $customer['fixedphone'] ?></td>
...
<?php
  ...
  public static function genCustomerForm( $mode, $config, $customer ) {
    ...
    if ( $mode === 'edit' ) {
      ...
      $action   = 'edit.php';
      $image = $customer['image'] ? '../../../../images/' . $config['imagePath']['customers'] . $customer['image'] : 'image_empty.png';
...
<?php
  ...
  public static function genCustomerSheet( $config, $customer ) {
    ...
    $action = htmlspecialchars( $_SERVER["PHP_SELF"] );
    $imagePath  = '../../../../images/' . ($customer['image'] ? $config['imagePath']['customers'] . $customer['image'] : 'image_empty.svg');
    $imageAlt = $customer['title'];
?>
    <div class="container-fluid py-4 px-4">
