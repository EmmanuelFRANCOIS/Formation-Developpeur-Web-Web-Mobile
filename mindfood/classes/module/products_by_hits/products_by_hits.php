...
/**
 * @class   ModProductsByHits module
 * @summary Class to extract products by hits in DB
 *          and display them where this module
 *          is applied
 */
Class ModProductsByHits {

  /**
   * @function getProductsByHits()
   ...
   *        ]
   */
  private function getProductsByHits( $options = null ) {
    ...
    switch ($options['mode']) {
      case 'best'  : $orderby = 'ORDER BY prd.hits DESC '; break;
      case 'worst' : $orderby = 'ORDER BY prd.hits ASC  '; break;
      default      : $orderby = 'ORDER BY prd.hits DESC '; break;
    }
   ...
   *           ]
   */
  public static function genProductsByHits( $options = null ) {
    ...
    $products = ModProductsByHits::getProductsByHits( $options );
  ...
  ?>
    <div class="container-fluid">
      <div class="container py-4 my-3">
            ...
            <div class="col">
                <div class="card h-100 bg-light text-center">
                  ...
                  <div class="card-footer text-start mt-2 pt-2">
                    ...
                    <div class="card-text mt-2">Vues : <?php echo $product['hits']; ?></div>
                  </div>
        ...
        <div class="my-3 fs-5 text-end">Voir le classement complet des <a class="btn btn-success fs-5 fw-bold py-1 px-3 more" href="#">"Livres" populaires</a></div>
      </div>
    </div>
  <?php
