...
ViewTemplateSite::genHead( $config, 'Mes Favoris' );
ViewTemplateSite::genHeader( $config, 'Mes Favoris' );
ViewCustomerAuth::genCustomerFavorites( $config, 'Mes Favoris', $customer );
